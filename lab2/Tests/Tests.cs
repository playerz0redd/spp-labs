...
namespace Tests
{
    public class UserTests
    {
        ...
        public void Setup()
        {
            ...
            string uniqueKey = "DefaultName_" + Guid.NewGuid();
            SharedContext.Set(uniqueKey, "Admin");

            _service.AddUser(new User { Username = "Admin", Age = 30, Email = "admin@system.com" });
        }

        [Test(Priority = 1, Description = "Успешное добавление пользователя")]
        ...
        [Test(Description = "Успешное удаление пользователя")]
        ...
        [Test(Description = "Пакетное добавление пользователей")]
        ...
        [Test(Description = "Мягкое удаление (Деактивация)")]
        ...
        [Test(Description = "Получение только активных пользователей")]
        ...
        [Test(Description = "Поиск по подстроке")]
        ...
        [Test(Description = "Поиск самого старшего пользователя")]
        ...
        [Test]
        [Ignore(Reason = "API еще не готово")]
